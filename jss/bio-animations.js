...
$(function () {
    ...
    if($(window).width() > 1330){
        ...
        $(window).scroll(function () {
            ...
            if (!haveDisplayedTravel && isInViewport(document.querySelector('#travel-wrapper')) ) {
            ...
            if (!haveDisplayedMotor && isInViewport(document.querySelector('#motor-activ')) ) {
